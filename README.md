...
- [Onchain Development Workflow](#onchain-development-workflow)
  - [Configuration](#configuration)
  - [Testing Your Setup](#testing-your-setup)
  - [Publishing Your Dataset](#publishing-your-dataset)
...
Ready to move from local Anvil development to Ethereum mainnet, Base, or Arbitrum? This section covers configuring your Amp instance to consume published blockchain data, exploring published datasets, testing your setup, and publishing your dataset to the Amp registry.
...
Once the `amp.config.ts` has been updated to be onchain, it will pull from onchain data instead of your local anvil instance. 

**Discover More Patterns:**

Explore published datasets in the [Amp Dataset Registry](https://playground.amp.thegraph.com/) to discover novel ways to transform your data.

## Testing Your Onchain Setup

Verify your dataset queries onchain data correctly.
...
You should see recent Ethereum mainnet blocks, confirming you're querying onchain data.
